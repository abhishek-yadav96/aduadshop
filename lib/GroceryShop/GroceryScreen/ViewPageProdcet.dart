...
import 'RealtedProduct.dart';

const List<String> list = <String>['1/2kg', '1kg', '1/3kg', '1/4kg'];

class ViewWhole extends StatefulWidget {
  const ViewWhole({Key? key}) : super(key: key);

  @override
  State<ViewWhole> createState() => _ViewWholeState();
}

class _ViewWholeState extends State<ViewWhole> {
